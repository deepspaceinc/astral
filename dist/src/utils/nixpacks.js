 ...
 */
async function updateNixpacksDockerfile() {
    try {
 ...
 */
export async function genNixpacks(entrypoint) {
    try {
        ...
        execSync(`nixpacks build . --name ${name} -o ./.astral --env PORT=80,NIXPACKS_PATH=${project}`, { encoding: 'utf8' });
